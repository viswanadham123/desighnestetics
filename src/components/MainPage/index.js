...
const MainPage = () => {
  ...
  const carCategories = {
    ...
    HATCHBACK: [
      ...
      { heading: 'Electric Compact Hatchback', priceRange: '$35,000 - $45,000' },
      { heading: 'Electric Midsize Hatchback', priceRange: '$40,000 - $50,000' },
  ...
  return (
    <div>
      ...
      <div className="top1">
 <div className="service-svg"><img
    src="/images/tellephone.svg"
    alt="Service"
...
/>
  ...
  className="social-media-icon"/>
      ...
      <div className="top-div2">
        ...
        <div className="div2-sidesection">
            <div className="dropdown1">
                <div>
                <p className="allcars" onClick={ ()=>handleItemClick1("all cars")}>All Cars</p>
                </div>
          ...
          {selectedCar==="all cars" &&openBox  && (
            ...
            <div className="dropdown1">
                <div>
                <p className="allcars"  onClick={ ()=>handleItemClick1("Our Services")}>Our Services</p>
                </div>
          
          {selectedCar==="Our Services" && openBox&& (
           <div className="car-dropdown">
           <p onClick={() => handleActionSelection('Test Drive')}>Test Drive</p>
           <p onClick={() => handleActionSelection('Service Booking')}>Service Booking</p>
           <p onClick={() => handleActionSelection('Get Finance')}>Get Finance</p>
           <p onClick={() => handleActionSelection('Get Insurance')}>Get Insurance</p>
           <p onClick={() => handleActionSelection('Bodyshop')}>Bodyshop</p>
           <p onClick={() => handleActionSelection('Exchange Your Car')}>Exchange Your Car</p>
         </div>)}
            </div>
        
            <div className="dropdown1">
                <div>
                <p className="Contact Us" onClick={ ()=>handleItemClick1("Contact Us")}>Contact Us</p>
                </div>
            ...
            <div className="dropdown1">
                <div>
              <a  href="https://hpromise.tridenthyundai.com/hyundai-used-cars-in-bangalore.html" target="_blank">  <p className=">H-Promise" onClick={ ()=>handleItemClick1("H-Promise")}>H-Promise</p></a> 
                </div>
          
        
            </div>
            
               <button onClick={ ()=>handleItemClick1("Button")} className="browse-button"> % Browse Offers</button>
      ...
      {selectedCar==="Contact Us" && (
           ...
           <p className="">Find Trident Hyundai Showrooms & Service Centres in Bangalore</p>
      ...
      {selectedItem==="Showrooms"?  
         <div  className="directions-div2">
           <div className="directions-div" >
               ...
               <h2>Sankey Road</h2>
               <p>#1, Lower Palace Orchard, Sankey Road, Sadashivnagar, Bangalore - 560003</p>
               <p>08043433333</p>
               <p>7353762526</p>
               <p>9900115133</p>
           ...
           selectedItem==="ServiceCenter"?<div  className="directions-div2">
           <div className="directions-div" >
  ...
  />
           ...
           <form>
             ...
             <p>By submitting this form, you agree to receive marketing messages & calls from Trident Hyundai.*</p>
           </form>
               </div>
           <div className="image-container">
       <img src="https://www.tridenthyundai.com/images/offers-new.png" alt="Offer" />
     </div>
         </div>}
      ...
      {selectedCar==="all cars"&&(
         ...
         {selectedCar==="Our Services"&& (
           ...
           <div className="image-container">
       <img src="https://www.tridenthyundai.com/images/testdrive-img.png" alt="Offer" />
     </div>
         </div>
    ...
    <div>
      ...
      <footer className="footer">
        <p>Copyright © TRIDENT AUTOMOBILES (BANGALORE) PRIVATE LIMITED. ALL RIGHTS RESERVED.</p>
        <div className="social-media">
          <p>Follow us on:</p>
          <a href="#" target="_blank" rel="noopener noreferrer">
            Facebook
